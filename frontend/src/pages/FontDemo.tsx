  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">
        Démonstration de la police Manrope sur LireLibre
      </h1>
      
      <div className="space-y-6">
        {/* Information générale */}
        <section className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-4">Police par défaut : Manrope</h2>
          <p className="text-gray-600 mb-4">
            Manrope est maintenant la police par défaut de LireLibre. Elle est moderne, lisible et optimisée pour le web.
            Tous les textes du site utilisent automatiquement cette police.
          </p>
          <div className="text-sm text-gray-500">
            <strong>Poids disponibles :</strong> 200 (Extra Light), 300 (Light), 400 (Regular), 500 (Medium), 600 (Semi Bold), 700 (Bold), 800 (Extra Bold)
          </div>
        </section>

        {/* Poids de police */}
        <section className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-4">Poids de police</h2>
          <div className="space-y-3">
            <p className="font-extralight text-lg">Extra Light (200) - Le texte le plus léger pour les accents subtils</p>
            <p className="font-light text-lg">Light (300) - Parfait pour les sous-titres et descriptions</p>
            <p className="font-normal text-lg">Regular (400) - Le poids standard pour le corps de texte</p>
            <p className="font-medium text-lg">Medium (500) - Idéal pour mettre en évidence sans être trop fort</p>
            <p className="font-semibold text-lg">Semi Bold (600) - Parfait pour les sous-titres importants</p>
            <p className="font-bold text-lg">Bold (700) - Pour les titres et éléments importants</p>
            <p className="font-extrabold text-lg">Extra Bold (800) - Pour les titres principaux qui attirent l'attention</p>
          </div>
        </section>
