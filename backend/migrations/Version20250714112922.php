 ...
 */
final class Version20250714112922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stories ALTER genre DROP DEFAULT');
        $this->addSql('ALTER TABLE stories ALTER genre SET NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER is_published DROP DEFAULT');
        $this->addSql('ALTER TABLE stories ALTER is_published SET NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER view_count DROP DEFAULT');
        $this->addSql('ALTER TABLE stories ALTER view_count SET NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER like_count DROP DEFAULT');
        $this->addSql('ALTER TABLE stories ALTER like_count SET NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER language DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE stories ALTER genre SET DEFAULT \'fiction\'');
        $this->addSql('ALTER TABLE stories ALTER genre DROP NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER is_published SET DEFAULT false');
        $this->addSql('ALTER TABLE stories ALTER is_published DROP NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER view_count SET DEFAULT 0');
        $this->addSql('ALTER TABLE stories ALTER view_count DROP NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER like_count SET DEFAULT 0');
        $this->addSql('ALTER TABLE stories ALTER like_count DROP NOT NULL');
        $this->addSql('ALTER TABLE stories ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE stories ALTER updated_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        ...
        $this->addSql('ALTER TABLE stories ALTER language SET DEFAULT \'fr\'');
